...
# python manage.py runscript top_skills_backend_img -v2
def run():
    # Создание DataFrame из данных
    df = pd.read_csv('backend_skills_graph.csv')
    ...
    plt.title('Рост самых популярных навыков бэкендера 2023 года')
    plt.xlabel('Год')
    ...
    plt.savefig(os.path.join(settings.BASE_DIR, 'vacancies', 'static', 'vacancies', 'img', 'top_skills_backend_graph.png'))
